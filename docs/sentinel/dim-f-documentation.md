...
- CHANGELOG updated — user-facing changes documented; if auto-generated by release tooling, verify release inputs (commit messages, changeset files) are correct instead
